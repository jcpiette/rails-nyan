...
user3 = User.create!(first_name: 'Olivia', last_name: 'S.', full_name: "Olivia Patterson", email: "oliviapatterson123@live.com", password: "Test123")
user4 = User.create!(first_name: 'Jean-Charles', last_name: 'P.', full_name: "Jean-Charles P.", email: "piette.jc@me.com", password: "Test123")
